...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="include/login.inc.php" method="POST">
                ...
                <div class="form-actions">
                    <button class="pull-right btn btn-success" type="submit" name="login">Sign Up</button>
                </div>
            </form>
        </div>
